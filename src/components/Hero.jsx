  ...
  return (
    <section id="home" className="flex flex-col items-start pt-12 md:pt-0">
      ...
      <p className="text-lg text-zinc-400 mb-12 max-w-xl">
        A brutal, community-driven survival experience. Scavenge, build, and outlive the horde in a meticulously crafted world.
      </p>
      ...
      <div className="w-full bg-zinc-900/40 border border-zinc-800/60 rounded-xl p-5 mb-10 backdrop-blur-sm">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <div className="flex flex-col gap-1.5">
            <span className="text-xs font-medium text-zinc-500 uppercase tracking-widest">Status</span>
          ...
          <div className="flex flex-col gap-1.5">
            <span className="text-xs font-medium text-zinc-500 uppercase tracking-widest">Players</span>
            <span className="text-sm font-medium text-zinc-200">
              18 <span className="text-zinc-600">/</span> 64
            </span>
          </div>
          <div className="flex flex-col gap-1.5">
            <span className="text-xs font-medium text-zinc-500 uppercase tracking-widest">IP Address</span>
            <span className="text-sm font-medium text-zinc-200 font-mono">123.45.67.89</span>
          </div>
          <div className="flex flex-col gap-1.5">
            <span className="text-xs font-medium text-zinc-500 uppercase tracking-widest">Port</span>
